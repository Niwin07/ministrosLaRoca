...
import { Search, Music2, ChevronDown, ChevronLeft, ChevronRight, X, Pencil, SlidersHorizontal, Play } from "lucide-react";
              ...
              <li key={c.id_cancion} className="overflow-hidden rounded-xl border border-line bg-card">
                ...
                <details className="group md:hidden">
                  ...
                  <div className="space-y-4 border-t border-line px-4 py-4">
                    {c.link_referencia && (
                      <a
                        href={c.link_referencia}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 rounded-full border border-violet-500/30 bg-violet-500/10 px-3.5 py-2 text-xs font-semibold text-violet-600 transition-colors hover:bg-violet-500/20 dark:text-violet-400"
                      >
                        <Play size={11} />
                        Escuchar referencia
                      </a>
            ...
            <>
              ...
              <div className="flex items-center justify-between border-b border-line px-6 py-4">
                ...
                <div className="flex items-center gap-3 shrink-0 ml-4">
                  ...
                  {seleccionada.link_referencia && (
                    <a
                      href={seleccionada.link_referencia}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 rounded-xl border border-violet-500/30 bg-violet-500/10 px-3 py-1.5 text-xs font-semibold text-violet-600 transition-colors hover:bg-violet-500/20 dark:text-violet-400"
                    >
                      <Play size={11} />
                      Escuchar
                    </a>
